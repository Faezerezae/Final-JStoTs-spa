...
export const SignupPage = (notifElement?: string) => {
  return `
    ${notifElement || ""}
      ...
      <div class="w-full p-4 bg-white space-y-6 text-center relative">
        <h5 class="font-semibold text-3xl text-gray-900 text-center">
      Signup to Your Account
        </h5>
        <div class="relative mb-6 text-gray-500 mx-2 hover:border-black hover:text-black">
      <div
      ...
      <i class="bi bi-eye-slash" id="eye"></i>
        ...
        <button onclick="navigate('/login')" class="font-bold text-xl text-gray-900 text-center active:underline"
        >
        login
        </button>
