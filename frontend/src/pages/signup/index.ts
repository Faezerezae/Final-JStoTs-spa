...
export const SignupPage=(router:Navigo)=>{
...
<form class="space-y-6" id="signupForm">
  ...
  <div class="relative mb-6 text-gray-500  hover:border-black hover:text-black">
    <div
  ...
  <button onclick="goToLoginPage()" class="absolute left-48 font-bold text-center flex justify-center items-center cursor-pointer hover:underline"
  >
  login
  </button>
...
<div
  class="p-4 mt-6 text-sm text-red-800 rounded-lg bg-red-100 hidden"
  role="alert"
  id="signupFormError"
></div>
</div>
